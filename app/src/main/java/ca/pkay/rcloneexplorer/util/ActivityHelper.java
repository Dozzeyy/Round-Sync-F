...
public class ActivityHelper {
    ...
    public static final int OLED_DARK = 3;
    ...
    public static void applyTheme(Activity activity) {
        ...
        if (mode.equals(String.valueOf(OLED_DARK))) {
    ...
    public static boolean isDarkTheme(Context context) {
        ...
        if(mode.equals(String.valueOf(LIGHT))) {
            return false;
        } else if(mode.equals(String.valueOf(DARK)) || mode.equals(String.valueOf(OLED_DARK))) {
            return true;
        } else {
