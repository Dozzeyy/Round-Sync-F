...
public class SettingsFragment extends Fragment {
    ...
    public final static int SECURITY_SETTINGS = 6;
    ...
    private void setClickListeners(View view) {
        ...
        view.findViewById(R.id.security_settings).setOnClickListener(v -> clickListener.onSettingCategoryClicked(SECURITY_SETTINGS));
