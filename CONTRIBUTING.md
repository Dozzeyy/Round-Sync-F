...
- [search existing issues](https://github.com/Dozzeyy/Round-Sync-F/issues?q=is%3Aissue)
...
## Localize Round Sync
 - Download [strings.xml](https://github.com/Dozzeyy/Round-Sync-F/blob/master/app/src/main/res/values/strings.xml) file.
